...
')
     ...
     */ 
        ...
        {
                        /** @var \Wovosoft\BdHrmProfile\BdHrmProfile $instance */
                        return $instance->getProfile($profile);
        }
                    /**
         * Note: Before add/update any property validate the property values with the rules associated with the models.
         *
         * @param \Wovosoft\BdHrmProfile\Enums\ProfileRelations|string $type The Parameter with Appropriate Child Model.
         * @param \Wovosoft\BdHrmProfile\Models\Profile $profile Parent Model under which the related model is going to be attached.
         * @throws \Throwable
         * @static 
         */ 
        public static function addProperty($type, $profile, $validatedData)
        {
                        /** @var \Wovosoft\BdHrmProfile\BdHrmProfile $instance */
                        return $instance->addProperty($type, $profile, $validatedData);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function updateProperty($model, $validatedData)
        {
                        /** @var \Wovosoft\BdHrmProfile\BdHrmProfile $instance */
                        return $instance->updateProperty($model, $validatedData);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function deleteProperty($model)
        {
                        /** @var \Wovosoft\BdHrmProfile\BdHrmProfile $instance */
                        return $instance->deleteProperty($model);
        }
                    /**
         * 
         *
        ...
        {
                        return \Wovosoft\BdHrmProfile\BdHrmProfile::routes();
        }
     ...
     */ 
         ...
         * @return \Wovosoft\BkbOffices\Actions\Offices 
         * @static 
         */ 
        public static function offices($newInstance = false)
        {
                        /** @var \Wovosoft\BkbOffices\BkbOffices $instance */
                        return $instance->offices($newInstance);
        }
                    /**
         * Returns instance of Wovosoft\BkbOffices\Actions\OfficeTypes::class which contains all CRUD methods
         *
         * @param bool $newInstance
         * @return \Wovosoft\BkbOffices\Actions\OfficeTypes 
         * @static 
         */ 
        public static function officeTypes($newInstance = false)
        {
                        /** @var \Wovosoft\BkbOffices\BkbOffices $instance */
                        return $instance->officeTypes($newInstance);
        }
                    /**
         * 
         *
        ...
        public static function routes()
        {
                        return \Wovosoft\BkbOffices\BkbOffices::routes();
        }
